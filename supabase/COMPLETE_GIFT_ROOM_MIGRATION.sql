-- =====================================================
-- COMPLETE GIFT ROOM SYSTEM MIGRATION FOR SUPABASE
...
-- 8. Function to generate secure gift room token
...
-- 9. Function to generate temp reservation token
...
-- 10. Function to create gift room with validation
...
-- 11. Function to create reservation
...
-- 13. Function for cleanup expired items
...
DROP TRIGGER IF EXISTS update_gift_rooms_updated_at ON public.gift_rooms;
CREATE TRIGGER update_gift_rooms_updated_at
  BEFORE UPDATE ON public.gift_rooms
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();

-- 15. Add total_spent tracking for referral tiers (if not exists)
DO $$
BEGIN
...
-- 
-- This creates:
-- - 4 tables: gift_rooms, reservations, gift_claims, gift_room_activities
-- - 6 functions: token generators, room creation, reservation, claiming, cleanup
-- - All necessary indexes for performance
-- - Row Level Security policies
-- - Triggers for updated_at timestamps
-- 
-- Your Gift Room System is now ready to use!
-- =====================================================