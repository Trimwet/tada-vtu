-- Drop existing function to clear up any ambiguity/overloads
DROP FUNCTION IF EXISTS public.create_reservation(UUID, TEXT, JSONB);
DROP FUNCTION IF EXISTS public.create_reservation(TEXT, TEXT, JSONB);
-- Drop any other variants just in case
DROP FUNCTION IF EXISTS public.create_reservation;

-- Recreate the function with strict signature
