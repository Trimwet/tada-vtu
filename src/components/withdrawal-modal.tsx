        ...
        <div className="max-w-lg mx-auto px-4 py-6 space-y-6">
          ...
          {step === "amount" && (
            <>
              ...
              {/* Flow hint */}
              <div className="flex items-center gap-3 p-3 rounded-xl border border-border" style={{ backgroundColor: '#141414' }}>
                <IonIcon name="information-circle-outline" size="20px" className="text-muted-foreground shrink-0" />
                <p className="text-xs text-muted-foreground">
                  Enter amount, then select your bank and account to withdraw to.
                </p>
              </div>
                  ...
                  {amount && parseFloat(amount) >= MIN_WITHDRAWAL && (
                    <div className="bg-muted/50 rounded-xl p-4 space-y-3">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium text-orange-500">₦{fee}</span>
                      </div>
                ...
                >
                  {processing ? (
                    <div className="flex items-center gap-2">
                      <ButtonLoading type="processing" text="Processing..." />
                    </div>
                  ) : (
                    "Confirm Withdrawal"
                  )}
