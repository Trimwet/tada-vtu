...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await signUp(email, password, fullName, phoneNumber, referralCode || undefined);
  ...
  // Common input class
  const inputClass = "w-full h-10 pl-10 pr-3 rounded-md bg-background border border-border text-foreground text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500 transition-colors";
